...
const PageContent = ({ categoryId }: PageContentProps) => {
  ...
  useEffect(() => {
    const fetchPost = async () => {
      const postUrl = `${process.env.NEXT_PUBLIC_BASE_API_URL}/get_categoryById.php?category_id=${categoryId}&limit=${limit}`;
